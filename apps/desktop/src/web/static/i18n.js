...
const TRANSLATIONS_EN = {
  ...
  "适用于 Switch1 和 Switch Lite；此模式使用启用 SWITCH_LITE 的稳定构建（禁用 BT modem sleep、固定发送节奏并延长拥塞重试）以提升配对与按键稳定性。": "For Switch 1 and Switch Lite. This mode uses the stable SWITCH_LITE build, disabling BT modem sleep, fixing the send cadence, and extending congestion retries to improve pairing and button stability.",
  "ESP32-WROOM-32 / ESP-32S（Switch 2 模式）": "ESP32-WROOM-32 / ESP-32S (Switch 2 mode)",
  "ESP32-WROOM-32 / ESP-32S（Switch1 和 Lite 模式）": "ESP32-WROOM-32 / ESP-32S (Switch 1 and Lite mode)",
